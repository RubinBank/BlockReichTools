...
public class MySQL {
        public static void setPassword(String p_n, String password){
                Connection con = BlockReichToolsPlugin.getConnection();
        ...
        public static boolean inDB(String p_n){
                ...
                try{
                        ...
                        BlockReichToolsPlugin.severe("MySQL Exception: " + e.toString() + "\n @ inDB Method");
                        return false;
                }
        }
        public static void addUser(String p_n){
                ...
                try{
                        ...
                        BlockReichToolsPlugin.severe("Failed to add user! Error:\n" + e.toString() + "\n @ Query" + query);
                }
        }
        public static void updateUserLogin(String p_n){
                ...
                try{
                        ...
                        BlockReichToolsPlugin.severe("Failed to update User login! Error:\n" + e.toString() + "\n @ Query" + query);
                }
        }
        private static enum MySQLCommandType {
                ...
                public void msg(String msg, CommandSender sender){
                        switch(this){
                        case CONSOLE:
                                BlockReichToolsPlugin.info(msg);
                                break;
                        case PLAYER:
        ...
        public static boolean MySQLCommand(String[] args, CommandSender sender){
                ...
                try{
                        ...
                        if(args.length == 0){
                                switch(type){
                                case CONSOLE:
                                        BlockReichToolsPlugin.info("MySQL Command. Write /mysql [query...] to execute a Query or /mysql update [query...] to execute a update.");
                                        break;
                                case PLAYER:
                                ...
                                if(args.length > 2){
                                        if(args[0].equals("update")){
                                                ...
                                                try{
                                                        ...
                                                        BlockReichToolsPlugin.severe("Command failed! Error:\n" + e.toString() + "\n @ Query" + query);
                                                }
                                                return true;
                                        }
                                }
                        ...
                        for(int i = 0; i < results.length; i++){
                                ...
                                BlockReichToolsPlugin.info(out);
                                else
                        ...
                        BlockReichToolsPlugin.severe("MySQL exception:\n" + e.toString());
                        return true;
                }
        }
        public static void addSignToDB(Location loc, SignPos pos, SignType t){
                ...
                try{
                        ...
                        BlockReichToolsPlugin.severe("Failed to insert Sign! Error:\n" + e.toString() + "\n @ Query" + query);
                }
        }
        public static void loadSigns(){
                ...
                try{
                        ResultSet rs = con.createStatement().executeQuery(query);
                        BlockReichToolsPlugin.info("Executed Query");
                        while(rs.next()){
                                x = rs.getInt("LocX");
                                y = rs.getInt("LocY");
                                z = rs.getInt("LocZ");
                                ...
                                BlockReichToolsPlugin.severe("Invalid Sign in DB: SignType '" + rs.getString("Type") + "' unknown.");
                                Tools.addSign(new Location(world, x, y, z), pos, t);
                                BlockReichToolsPlugin.info("Added Sign");
                        }
                }catch (SQLException e) {
                        BlockReichToolsPlugin.severe("MySQL ResultSet Exception @ load Signs\n" + e.toString());
                        e.printStackTrace();
                }
        }
        public static void removeSign(Location loc){
                BlockReichToolsPlugin.info("Requested Sign Remove");
                ...
                try{
                        ...
                        BlockReichToolsPlugin.severe("Failed to remove Sign! Error:\n" + e.toString() + "\n @ Query" + query);
                }
                BlockReichToolsPlugin.info("Removed Sign.");
        }
}
